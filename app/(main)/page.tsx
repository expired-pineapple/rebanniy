  ...
  <div className="relative z-10 w-full pt-52">
    <div className="container mx-auto">
      <div className="relative w-full">
              ...
              <motion.div initial={{x: 300,  opacity:0}} animate={{x:0,  opacity:10}}  transition={{stiffness: 5}} className="w-full md:w-1/2  md:order-1">
                  <div className="relative w-full">
                    <img
...
<div className="grid sm:grid-cols-2 grid-cols-1 gap-10 sm:px-20 my-10 text-left sm:w-3/4">
  ...
  <div className="flex flex-col gap-8">
    ...
    <div className="relative   rounded-full w-10 h-10  p-10 border-2 border-[#DB9E30]  flex items-center justify-center">
...
<div className="mt-32 relative w-100 hidden sm:block">
...
<img decoding="async" src="https://nauthemes.com/demo/muezzin/wp-content/plugins/ingeniofy-plus/elementor-widgets/widgets_classes/../../assets/images/shape2.png" alt="" />
    ...
    <h1 className="capitalize heading sm:text-6xl text-4xl sm:w-[50%] tracking-wide">Our Services</h1>
</div>
<div  className="relative w-full">
...
<div className="absolute inset-0 mix-blend-exclusion" style={{backgroundImage: "url(https://nauthemes.com/demo/muezzin/wp-content/plugins/ingeniofy-plus/elementor-widgets/widgets_classes/../../assets/images/tq-bg2.png)"}}>
  ...
  <div className="flex flex-col gap-4 w-full items-center justify-center text-center pt-20 mb-10">
...
<img className="w-20 h-20 mb-4 bg-no-repeat" decoding="async" src="https://nauthemes.com/demo/muezzin/wp-content/plugins/ingeniofy-plus/elementor-widgets/widgets_classes/../../assets/images/shape2.png" alt="" />    
<Carousel />
    </div>
</div>
</main>
