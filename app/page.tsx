  ...
  <div className="relative z-10 w-full pt-52">
    <div className="container mx-auto">
      <div className="relative w-full">
              ...
              <motion.div initial={{x: "100vw"}} animate={{x:0}}  transition={{stiffness: 5}} className="w-full md:w-1/2  md:order-1">
                  <div className="relative w-full">
                    <img
...
<div className="grid sm:grid-cols-2 grid-cols-1 gap-10 sm:px-20 my-10 text-left sm:w-3/4">
  ...
  <div className="flex flex-col gap-8">
    <div className="flex gap-4 group flex-col sm:flex-row items-center text-center">
...
<div  className="relative w-full">
  <div  className="flex flex-col lg:flex-row items-center justify-center">
    ...
    <div  className="flex flex-col sm:items-start items-center justify-center w-full max-w-xs p-6">
